              ...
              {products.map((product) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="w-full h-52 relative rounded-2xl flex items-center justify-center bg-gradient-to-br from-slate-50 to-emerald-50/20 overflow-hidden">
                      ...
                      <Image 
                        ...
                        className="object-cover group-hover:scale-105 group-hover:-translate-y-1 transition-all duration-700 ease-out z-10"
                      />
