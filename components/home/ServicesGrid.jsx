            ...
            return (
              <AnimatedReveal key={service.slug} animation="fade-up" delay={(index % 3) * 120}>
                <Link 
                  ...
                  className="clean-card group flex flex-col h-full bg-white p-6 rounded-3xl border border-slate-200 shadow-sm hover:shadow-2xl hover:-translate-y-2.5 transition-all duration-400 overflow-hidden"
                >
