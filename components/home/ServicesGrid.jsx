              ...
              <AnimatedReveal key={service.slug} animation="fade-up" delay={(index % 3) * 100}>
                <ThreeDCard depth={15}>
                  ...
                  >
                    ...
                    <div className="w-full h-48 sm:h-52 relative rounded-2xl flex items-center justify-center p-2 bg-gradient-to-br from-slate-50 to-blue-50/20 overflow-hidden">
                      ...
                      <Image 
                        ...
                        className="object-contain rounded-2xl group-hover:scale-105 group-hover:-translate-y-1 transition-all duration-700 ease-out drop-shadow-xl relative z-10 p-2"
                      />
